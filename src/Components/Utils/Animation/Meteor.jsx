...
export const BackgroundBeams = React.memo(({ className }) => {
  ...
  return (
    <div
      className={cn(
        "fixed inset-0 pointer-events-none flex h-full w-full items-center justify-center [mask-repeat:no-repeat] [mask-size:40px]",
        className
      )}
    >
      <svg
      ...
      >
        {/* Static Path: faint background trail */}
        <path
          d={paths.join(" ")}
        ...
        <defs>
          {/* Linear Gradients for each path */}
          {paths.map((_, index) => (
            ...
            >
              ...
              <stop offset="32.5%" stopColor="#39dcc5" />
